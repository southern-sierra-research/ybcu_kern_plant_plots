...
e_density_24_hits_sum_w_plot = veg_plots_24 %>%
  rename(OBJECTID_plot = OBJECTID,
         CreationDate_plot = CreationDate,
         LastEditDate_plot = LastEditDate,
         Longitude = x,
         Latitude = y) %>%
  left_join(e_density_24_hits_sum, by = join_by(GlobalID == "Parent GUID"))

w_density_24_hits_sum_w_plot = veg_plots_24 %>%
  rename(OBJECTID_plot = OBJECTID,
         CreationDate_plot = CreationDate,
         LastEditDate_plot = LastEditDate,
         Longitude = x,
         Latitude = y) %>%
  left_join(w_density_24_hits_sum, by = join_by(GlobalID == "Parent GUID"))

n_density_24_hits_sum_w_plot = veg_plots_24 %>%
  rename(OBJECTID_plot = OBJECTID,
         CreationDate_plot = CreationDate,
         LastEditDate_plot = LastEditDate,
         Longitude = x,
         Latitude = y) %>%
  left_join(n_density_24_hits_sum, by = join_by(GlobalID == "Parent GUID"))

s_density_24_hits_sum_w_plot = veg_plots_24 %>%
  rename(OBJECTID_plot = OBJECTID,
         CreationDate_plot = CreationDate,
         LastEditDate_plot = LastEditDate,
         Longitude = x,
         Latitude = y) %>%
  left_join(s_density_24_hits_sum, by = join_by(GlobalID == "Parent GUID"))
